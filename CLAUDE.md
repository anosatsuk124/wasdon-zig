...
- **No raw byte memory.** WASM linear memory cannot be represented natively. Per `docs/spec_linear_memory.md`, model it as a `SystemObjectArray` (`object[]`) accessed via `SystemObjectArray.__GetValue__/__SetValue__` externs.
